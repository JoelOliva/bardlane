    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _userStore.SetUserNameAsync(user, await GenerateUserName(), CancellationToken.None);
        ...
        private async Task<string> GenerateUserName()
        {
            ...
            do
            {
                ...
                string[] words = JsonSerializer.Deserialize<string[]>(responseBody);
                username = string.Join('_', words);
                username += "_" + _random.Next(0, 10000);
